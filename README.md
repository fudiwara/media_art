...
##### [api2_1mp_cam_face.py](api2_1mp_cam_face.py)
...
#### [pygame_vis](pygame_vis)
当然ながらOpenCVでも画面描画を含めた結果のビジュアライズはできますが、ゲーム的な用途等を考えるとちょっと使いづらいです。そのため、画面描画全般をpygameで実装したサンプルも用意しています。